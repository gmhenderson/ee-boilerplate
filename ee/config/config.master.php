...
if (isset($config))
{
	...
	$env_config['theme_folder_path'] = $base_path . '/themes/core/';
 	$env_config['theme_folder_url'] = $base_url . '/themes/core/';
 	$env_config['path_third_themes'] = $base_path . '/themes/third_party/';
 	$env_config['url_third_themes'] = $base_url . '/themes/third_party/';
